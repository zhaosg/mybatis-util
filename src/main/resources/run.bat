...
java -jar mybatis-util-0.0.1-SNAPSHOT.jar  -tableName t_goods_browse -tablePrefix t
java -jar mybatis-util-0.0.1-SNAPSHOT.jar  -tableName t_goods_consult -tablePrefix t
java -jar mybatis-util-0.0.1-SNAPSHOT.jar  -tableName t_goods_evaluate -tablePrefix t
